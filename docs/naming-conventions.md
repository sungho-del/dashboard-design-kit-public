...
> 위 1~5는 "기술 네이밍(조회용)". 이건 **제품 이름을 짓는 절차**다.
>
> ⚠️ **이 절차를 돌리는 장치는 이 폴더에 없다.** 담당하던 `brand-strategist`(Stage 2a)와
> 그 계약서 `docs/schemas/brand-strategy.schema.md` 는 모두 삭제됐다. 아래는 **복구할 때를 위한
> 기록**이다 — 지금은 제품명을 사람이 정한다.
